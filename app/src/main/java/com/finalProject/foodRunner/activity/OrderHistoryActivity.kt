...
import com.finalProject.foodRunner.adapter.OrderHistoryAdapter
import com.finalProject.foodRunner.model.OrderHistoryRestaurant
    ...
    fun setItemsForEachRestaurant() {
        ...
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            try {
                ...
                val url = "http://" + getString(R.string.ip_address) + "/v2/orders/fetch_result/$userId"
