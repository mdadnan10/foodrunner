...
import com.finalProject.foodRunner.activity.CartActivity
import com.finalProject.foodRunner.model.RestaurantMenu
...
class RestaurantMenuAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolderRestaurantMenu, position: Int) {
        ...
        buttonProceedToCart.setOnClickListener {
            val intent = Intent(context as Activity, CartActivity::class.java)
